...
export class MapperService {
    public static MapProductToItem(prod: ProductModel): SpProductItem {
        return new SpProductItem({
            ...
            ReturnDateActual: prod.returnDateActual ? prod.returnDateActual.toJSON() : null,
            ReturnDateExpected: prod.returnDateExpected ? prod.returnDateExpected.toJSON() : null,
    ...
    public static MapItemToProduct(item: SpProductItem, attachments: Array<SpListAttachment>): ProductModel {
        return new ProductModel({
            ...
            returnDateExpected: item.ReturnDateExpected ? new Date(item.ReturnDateExpected) : null,
            returnDateActual: item.ReturnDateActual ? new Date(item.ReturnDateActual) : null,
